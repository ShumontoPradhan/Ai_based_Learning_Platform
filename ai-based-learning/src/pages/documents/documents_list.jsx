...
import DocumentCard from "../../documents/documentCard.jsx";
...
const DocumentsListPage =()=>{
    ...
    const renderContent =()=>{
                ...
                <div className="flex items-center justify-center min-h-[200px]">
                    <div className="text-center max-w-md">
                        ...
                        <p className="text-sm text-slate-500 mb-6">
                            Get started by uploading your first document. Click the "Upload Document" button to add files and start organizing your learning materials.
                        </p>
                        <button onClick={()=>setIsUploadModalOpen(true)} className="inline-flex items-center gap-2 px-6 bg-linear-to-r fromemerald-500 to teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-sm font-semibold transition-all duration-200 shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/30 active:scale-[0.98] rounded-xl">
        ...
        return (<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 x:grid-cols-4 gap-5">
            {documents?.map((doc)=>(
                <DocumentCard
                    key={doc._id}
                    document={doc}
    ...
    return(
        <div className="relative min-h-screen px-0 sm:px-2">
                ...
                <div className="flex items-center justify-between mb-10">
                    <div>
                        ...
                        <p className="text-slate-500 text-sm">
                            Manage and organize your documents in one place. Upload new files, view details, and keep your learning materials at your fingertips.
                        </p>
                    </div>
                    {documents.length > 0 && (
            ...
            {isUploadModalOpen &&(<div className="fixed inset-0 z-9999 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-sm">
                <div className="relative w-full max-w-lg bg-white/95 backdrop-blur-xl border border-slate-200/60 rounded-2xl shadow-slate-900/20 p-8">
                    {/* Close Button */}
                    <button onClick={()=> setIsUploadModalOpen(false)} className="absolute top-6 right-6 w-8 h-8 items-center justify-center rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-all duration-200">
                    ...
                    <div className="mb-6" >
                        ...
                        <p className="text-sm text-slate-500 mt-1">
                            Add a pdf document to your library and start creating flashcards to enhance your learning experience.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleUpload} className="space-y-5 ">
                        ...
                        <div className="space-y-2">
                            <label htmlFor="" className="block text-sm font-medium text-slate-700 uppercase tracking-wide">
                                Document Title
                            </label>
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative border-2 border-dashed border-slate-300 rounded-xl bg-slate-50/50 hover:border-emerald-400 hover:bg-emerald-50/30 transition-all duration-200">
                                ...
                                <div className="flex flex-col items-center justify-center py-10 px-6">
                                    <div className="w-14 h-14 rounded-xl bg-linear-to-r from-emerald-100 to-teal-100 flex items-center justify-center mb-3">
                                        <Upload className="w-7 h-7 text-emerald-600" strokeWidth={2}></Upload>
                                    </div>
                                    <p className="text-sm font-medium text-slate-700 mb-1">
                                        {uploadFile? (<span className="text-emerald-600">
                                            {uploadFile.name}
                                        </span>):(<>
                        ...
                        <div className="flex gap-3 pt-2">
                            ...
                            type="submit"
                            disabled={uploading}
                            className="flex-1 h-11 px-4 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white text-sm font-semibold transition-all duration-200 shadow-lg shadow-emerald-500/25 hover:shadow-xl hover:shadow-emerald-500/30 active:scale-[0.98] rounded-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
                                {uploading? (
